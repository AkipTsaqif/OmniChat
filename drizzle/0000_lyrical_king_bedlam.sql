...
CREATE TABLE "provider_settings" (
	...
	"provider" text DEFAULT 'omniroute' NOT NULL,
...
CREATE INDEX "idx_conversations_user_recent" ON "conversations" USING btree ("user_id","updated_at" DESC NULLS LAST);--> statement-breakpoint
